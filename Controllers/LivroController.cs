...
namespace Biblioteca.Controllers
{
    public class LivroController : Controller
    {
        ...
        public IActionResult Listagem(string tipoFiltro, string filtro, string itensPorPagina, int
        NumDaPagina, int PaginaAtual)
        {
            Autenticacao.CheckLogin(this);
       ...
       /* public IActionResult Listagem(string TipoFiltro, string Filtro, int p = 1)
        {
            ...
            LivroService livroService = new LivroService();
            int totalDeRegistro = livroService.NumeroDeLivros();
